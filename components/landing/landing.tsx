...
export function DotBackgroundDemo() {
  return (
    <div className="relative flex h-200 w-full items-center justify-center bg-white dark:bg-black">
      ...
      <p className="relative z-20 bg-linear-to-b from-neutral-200 to-neutral-500 bg-clip-text py-8 text-4xl font-bold text-transparent sm:text-5xl">
        Where Ideal Brands Meet Potential Promoter
        <p className=" flex justify-center">CollabX</p>
      </p>
    </div>
  );
}
